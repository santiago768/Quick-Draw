...
sketchtobedrawn = quick_draw_data_set[randomnumber];
document.getElementById("sketch_to_be_drawn").innerHTML = "sketch to be drawn " + sketchtobedrawn;
...
function setup() {
    ...
    canvas.mouseReleased(classificanvas);
